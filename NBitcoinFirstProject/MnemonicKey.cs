...
namespace NBitcoinFirstProject
{
    class MnemonicKey
    {
        ...
        private static Wordlist getItalianWordlist()
        {
            //from https://iancoleman.io/bip39/

            String[] wordlist = {"abaco", "abbaglio", "abbinato", "abete", "abisso", "abolire", "abrasivo", "abrogato", "accadere", "accenno",
...
"zircone", "zitto", "zolla", "zotico", "zucchero", "zufolo", "zulu", "zuppa"};
            ...
            Wordlist wlCustom = new Wordlist(wordlist, ' ', "Italian");
            return wlCustom;
        }
